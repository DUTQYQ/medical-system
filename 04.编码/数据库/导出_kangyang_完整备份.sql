...
INSERT INTO `alert_receiver` VALUES (70001,40001,3,'UNREAD',NULL,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(70002,40001,4,'UNREAD',NULL,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(70003,40001,2,'UNREAD',NULL,'2026-09-12 17:42:09','2026-09-12 17:42:09');
...
--
-- Dumping data for table `care_relation`
--

LOCK TABLES `care_relation` WRITE;
/*!40000 ALTER TABLE `care_relation` DISABLE KEYS */;
INSERT INTO `care_relation` VALUES (8001,4,2001,1,'2026-09-12 17:42:09','2026-09-12 17:42:09');
/*!40000 ALTER TABLE `care_relation` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `elder_profile`
--

LOCK TABLES `elder_profile` WRITE;
/*!40000 ALTER TABLE `elder_profile` DISABLE KEYS */;
INSERT INTO `elder_profile` VALUES (2001,2,'张桂兰','F','1948-03-12',158.0,62.0,'A','青霉素','高血压 8 年，长期服用氨氯地平','[\"高血压\"]','李强','13000000003',0,'2026-09-12 17:42:09','2026-09-12 17:42:09');
/*!40000 ALTER TABLE `elder_profile` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `family_bind`
--

LOCK TABLES `family_bind` WRITE;
/*!40000 ALTER TABLE `family_bind` DISABLE KEYS */;
INSERT INTO `family_bind` VALUES (9001,3,2001,'儿子','我是张桂兰的儿子','APPROVED',2,NULL,'2026-09-10 10:00:00','2026-09-12 17:42:09','2026-09-12 17:42:09');
/*!40000 ALTER TABLE `family_bind` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `health_record` VALUES (30001,2001,'BLOOD_PRESSURE',128.00,82.00,'2026-09-05 07:30:00',0,'',2,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(30002,2001,'BLOOD_PRESSURE',165.00,98.00,'2026-09-06 07:35:00',1,'早上起床后测量',2,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(30003,2001,'BLOOD_PRESSURE',170.00,100.00,'2026-09-07 07:40:00',1,'',2,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(30004,2001,'BLOOD_PRESSURE',178.00,102.00,'2026-09-08 07:42:00',1,'感觉头晕',2,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(30005,2001,'BLOOD_SUGAR',6.40,NULL,'2026-09-08 07:45:00',0,'空腹',2,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(30006,2001,'HEART_RATE',82.00,NULL,'2026-09-08 07:46:00',0,'',2,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(30007,2001,'SLEEP',5.50,3.00,'2026-09-08 06:30:00',0,'夜间易醒',2,'2026-09-12 17:42:09','2026-09-12 17:42:09');
...
--
-- Dumping data for table `health_warning`
--

LOCK TABLES `health_warning` WRITE;
/*!40000 ALTER TABLE `health_warning` DISABLE KEYS */;
INSERT INTO `health_warning` VALUES (40001,2001,30004,'BLOOD_PRESSURE','178/102',3,'PENDING','DATA_INPUT','该老人近 3 天血压持续处于 165~178 mmHg 区间，呈明显上升趋势，今日收缩压达 178 mmHg（高风险）。结合主诉头晕，建议尽快安排复诊，切勿自行加量服药。','SUCCESS','2026-09-08 07:42:00','2026-09-12 17:42:09');
/*!40000 ALTER TABLE `health_warning` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_config` VALUES (1,'BLOOD_PRESSURE_SYSTOLIC','{\"level0\":\"90~139\",\"level1\":\"140~159\",\"level2\":\"160~179\",\"level3\":\">=180\"}','threshold','threshold','血压·收缩压阈值（mmHg）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(2,'BLOOD_PRESSURE_DIASTOLIC','{\"level0\":\"60~89\",\"level1\":\"90~99\",\"level2\":\"100~109\",\"level3\":\">=110\"}','threshold','threshold','血压·舒张压阈值（mmHg）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(3,'BLOOD_SUGAR','{\"level0\":\"3.9~6.1\",\"level1\":\"6.2~7.0\",\"level2\":\"7.1~11.1\",\"level3\":\">=11.2\"}','threshold','threshold','血糖阈值（mmol/L，空腹参考）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(4,'HEART_RATE','{\"level0\":\"60~100\",\"level1\":\"50~59,101~110\",\"level2\":\"40~49,111~130\",\"level3\":\"<40 或 >130\"}','threshold','threshold','心率阈值（次/分）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(5,'SLEEP_HOURS','{\"level0\":\">=7\",\"level1\":\"6~7\",\"level2\":\"5~6\",\"level3\":\"<5\"}','threshold','threshold','睡眠时长阈值（小时）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(6,'STEP_COUNT','{\"level0\":\">=6000\",\"level1\":\"4000~5999\",\"level2\":\"2000~3999\",\"level3\":\"<2000\"}','threshold','threshold','日常步数阈值（步/日）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(7,'family_bind_max','5','number','system','单个老人可绑定的家属上限（D-02）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(8,'alert_unread_poll_sec','30','number','system','通知未读数前端轮询周期（秒，D-03）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(9,'ai_summary_timeout_sec','8','number','system','AI 摘要生成超时（秒），超时判失败并降级（D-04）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(10,'ai_summary_retry','1','number','system','AI 摘要失败重试次数（D-04）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(11,'emergency_keywords','[\"胸痛\",\"呼吸困难\",\"意识丧失\",\"昏厥\",\"无法起身\",\"大量出血\",\"言语不清\"]','json','system','紧急关键词：即使模型未判紧急，命中即由代码强制升级为 L4（R-01）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(12,'llm_provider','deepseek','string','system','大模型提供方（代码读取，切换模型只改此项 + .env 的 Key）',1,'2026-09-12 17:42:09','2026-09-12 17:42:09');
...
INSERT INTO `user` VALUES (1,'13000000001','$2b$12$KLC3i9QqsCforZFtVXnun.FUS8gmBPIDuRJ5XjKmlcljDKAd3DdUW','系统管理员','ADMIN',1,NULL,NULL,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(2,'13000000002','$2b$12$KLC3i9QqsCforZFtVXnun.FUS8gmBPIDuRJ5XjKmlcljDKAd3DdUW','张桂兰','ELDER',1,NULL,NULL,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(3,'13000000003','$2b$12$KLC3i9QqsCforZFtVXnun.FUS8gmBPIDuRJ5XjKmlcljDKAd3DdUW','李强','FAMILY',1,NULL,NULL,'2026-09-12 17:42:09','2026-09-12 17:42:09'),(4,'13000000004','$2b$12$KLC3i9QqsCforZFtVXnun.FUS8gmBPIDuRJ5XjKmlcljDKAd3DdUW','王护工','CARE',1,NULL,NULL,'2026-09-12 17:42:09','2026-09-12 17:42:09');
...
--
-- Dumping data for table `warning_handle_record`
--

LOCK TABLES `warning_handle_record` WRITE;
/*!40000 ALTER TABLE `warning_handle_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `warning_handle_record` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'kangyang'
--
...
-- Dump completed on 2026-09-15 10:19:52
